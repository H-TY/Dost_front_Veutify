  ...
  const createBookingOrder = async (fd) => {
    ...
    try {
      ...
      const reNowDate = computed(() => {
        ...
        const nowDateMonth =
          (nowDate.value.getMonth() + 1).toString().length > 1
            ? (nowDate.value.getMonth() + 1).toString()
        ...
        const nowDateDay =
          nowDate.value.getDate().toString().length > 1
            ? nowDate.value.getDate().toString()
            : nowDate.value.getDate().toString().padStart(2, "0");
