<template>
  <v-container fluid>
    ...
    <v-dialog v-model="dialog">
      <!-- 將外部資料傳入元件內 -->
      <OrderInfoCard :bigTitle="'是否要取消訂單？'" :orderInfoData="orderInfoData" :orderInfoDataImg="orderInfoDataImg" :changeOrderStatus="changeOrderStatus" :dialogClose="dialogClose" :submit="submit" :isSubmitting="isSubmitting"></OrderInfoCard>
    </v-dialog>
  </v-container>
</template>
